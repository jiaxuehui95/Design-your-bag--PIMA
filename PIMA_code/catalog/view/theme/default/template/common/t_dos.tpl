...
<head>
    ...
    <title>Taille du Sac à dos</title>
        ...
        <div class="row">
            ...
            <div class="col-md-offset-1 col-md-10 col-sm-12">
                <div class="section-title">
                    <h1>Choisir La Taille du Sac à dos</h1>
                </div>
                <div class="col-md-12 col-sm-12">
                    <div class="col-md-4 col-sm-4">
                        <img src="catalog/view/theme/default/images/sac/s-dos.jpg"  height="97%" width="97%" alt="petit" />
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <img src="catalog/view/theme/default/images/sac/m-dos.jpg"  height="98%" width="98%" alt="moyen" />
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <img src="catalog/view/theme/default/images/sac/l-dos.jpg"  height="97%" width="97%" alt="grand" />
                    </div>
                </div>
