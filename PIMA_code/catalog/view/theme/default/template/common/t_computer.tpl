...
<head>
    ...
    <title>Taille du Sac d'ordinateur</title>
        ...
        <div class="row">
            ...
            <div class="col-md-offset-1 col-md-10 col-sm-12">
                <div class="section-title">
                    <h1>Choisir La Taille du Sac d'ordinateur</h1>
                </div>
                <div class="col-md-12 col-sm-12">
                    <div class="col-md-4 col-sm-4">
                        <img src="catalog/view/theme/default/images/sac/s.png"  alt="petit" />
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <img src="catalog/view/theme/default/images/sac/m.png"  alt="moyen" />
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <img src="catalog/view/theme/default/images/sac/l.png"  alt="grand" />
                    </div>
                </div>
